...
<div class="row ms-1">
	<?=form_open('md-article/recs','class="row g-3 for-validation" id="myfrmsrec_artm" ');?>
		<div class="input-group input-group-sm">
			...
			<?=anchor('mymd-customer', 'Reset',' class="btn btn-primary" ');?>
		</div>
						...
						<thead>
							<tr>
								<th class="text-center">
									<?=anchor('mymd-customer/?maction=A_REC', '<i class="bi bi-plus-lg"></i>',' class="btn btn-success btn-sm p-1 pb-0 mebtnpt1" ');?>
								</th>
								<th>Customer Code</th>
							...
							if($rlist !== ''):
								...
								<tr <?=$on_mouse;?>>
									<td class="text-center" nowrap>
										<?=anchor('mymd-customer/?mtkn_etr=' . $mtkn_arttr, '<i class="bi bi-pencil-square"></i>',' class="btn btn-primary btn-sm p-1 pb-0 mebtnpt1" ');?>
									</td>
									<td nowrap><?=$row['CUST_CODE'];?></td>
									<td nowrap><?=$row['CUST_NAME'];?></td>
									<td nowrap><?=$row['CUST_ADDR1'];?></td>
									<td nowrap><?=$row['CUST_ADDR2'];?></td>
									<td nowrap><?=$row['CUST_ADDR3'];?></td>
		...
		.forEach(function (form) {
			form.addEventListener('submit', function (event) {
				...
				try {
					...
					type: "POST",
					url: '<?=site_url();?>search-mymd-customer',
