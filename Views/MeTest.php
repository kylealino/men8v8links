...
<button id="mbtn_mdata_post_tkn">Test POST MDATA-POS</button>
<div id="mewg_content"></div>
    <?php
...
<script>
	...
	jQuery('#mbtn_mdata_post_tkn').click(function() { 
		try { 
			__mysys_apps.mepreloader('mepreloaderme',true);

			var mparam = {
				metknkey:'7c2070df9e40e1af1d2ef5ea7b83428ad30d14842bd93945c18efa516926f718ef8338f0d71e4bbfceaa71319caa1c56bf0430e75f86d330ba48e113c63cb0ce'

		   }

			
			jQuery.ajax({ // default declaration of ajax parameters
				url: '<?=site_url()?>mdata-pos-mtkn',
				method:"POST",
