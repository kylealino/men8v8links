...
if ($myusermod->mysys_user_classgroup() == 'BR'):
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="mesales-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="<?=site_url();?>me-promo">
              <i class="bi bi-circle"></i><span>Promo Discount</span>
            </a>
          </li>

          <li>
            <a href="<?=site_url();?>me-threshold">
              <i class="bi bi-circle"></i><span>Threshold</span>
            </a>
          </li>

          <li>
            <a href="<?=site_url();?>me-voucher">
              <i class="bi bi-circle"></i><span>Voucher</span>
            </a>
          </li>

          <li>
            <a href="<?=site_url();?>me-buy1take1">
              <i class="bi bi-circle"></i><span>Buy 1 Take 1</span>
            </a>
          </li>

          <li>
            <a href="<?=site_url();?>me-buyanyatprice">
              <i class="bi bi-circle"></i><span>Buy any @ Price</span>
            </a>
          </li>

          <li>
            <a href="<?=site_url();?>me-wholesale">
              <i class="bi bi-circle"></i><span>Wholesale</span>
            </a>
          </li>
          <li>
            <a href="<?=site_url();?>postally_upload">
              <i class="bi bi-circle"></i><span>Postally Upload</span>
            </a>
          </li>
          <li>
            <a href="<?=site_url();?>mypos-reprint-logs">
              <i class="bi bi-circle"></i><span>POS Re-print Logs</span>
            </a>
          </li>
          <li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#mePOSPromotions-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-text"></i><span>Promotion</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="mePOSPromotions-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="<?=site_url();?>mypromo-spromo">
              <i class="bi bi-circle"></i><span>SPROMO</span>
            </a>
          </li>
        </ul>
      ...
      <li class="nav-item">
        ...
        <ul id="meexpenses-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="<?=site_url();?>myrfp">
              <i class="bi bi-circle"></i><span>RFP/PCF</span>
            </a>
          </li>
        </ul>
      </li><!-- End Expenses Nav -->
      ...
      <li class="nav-item">
        ...
        <ul id="mereports-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="<?=site_url();?>myreport-inventory">
...
<?php
elseif ($myusermod->mysys_user_classgroup() == 'HO'):
	echo view('templates/meheader02');
elseif ($myusermod->mysys_user_classgroup() == 'CS'):
