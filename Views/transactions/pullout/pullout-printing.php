...
$barcodeText = '12345678'; // Replace with your barcode text
$barcodeGenerator = new BarcodeGeneratorJPG();
$barcodeImagePath = 'D:\myproj\barcode.jpg';

file_put_contents($barcodeImagePath, $barcodeGenerator->getBarcode($barcodeText, $barcodeGenerator::TYPE_EAN_13));
...
$pdf->Image($barcodeImagePath, $barcodeX, $barcodeY, $barcodeWidth, $barcodeHeight);
...
$pdf->SetXY(177,38);  
$pdf->SetFont('Dot','',8);
$pdf->Cell(20,5,$print_time,'B',0,'L'); 
...
$pdf->SetY(-15);
$pdf->SetFont('Dot','',10);
$pdf->Cell(0,10,'Page '.$pdf->PageNo().'/{nb}'.' of PO NO: '.$potrx_no. '  Print Time:'.$print_time,0,0,'C');

//header page number
$pdf->SetY(2);
$pdf->SetX(150);
$pdf->SetFont('Dot','',10);
$pdf->Cell(0,10,'Page '.$pdf->PageNo().'/{nb}'.' of PO NO: '.$potrx_no,0,0,'C');

$pdf->SetY(6.5);
$pdf->SetX(150);
$pdf->AddFont('Dot2','','helveticai.php');
$pdf->SetFont('Dot2','',6);
$pdf->Cell(0,10,' DUPLICATE COPY: '.$potrx_no,0,0,'C');

$pdf->SetFont('Dot','',10);
$pdf->SetY(25);
$pdf->SetX(150);
$pdf->Cell(0,10,''.$potrx_no,0,0,'C');
...
$pdf->SetXY(23,$Y+17);
$pdf->Cell(100,5,($branch_name),'B',0,'L');

$pdf->SetXY(5,$Y+22);
$pdf->Cell(20,5,'COMPANY: ',0,0,'C');
$pdf->SetXY(23,$Y+22);
$pdf->Cell(100,5,$BRNCH_ACCT_COMPNAME,'B',0,'L');

$pdf->SetXY(5,$Y+27);
$pdf->Cell(20,5,'ADDRESS: ',0,0,'C');
$pdf->SetXY(23,$Y+27);
$pdf->Cell(100,5,$BRNCH_ADDR1,'B',0,'L');
