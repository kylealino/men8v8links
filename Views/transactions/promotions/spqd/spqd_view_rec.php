				...
				if($rlist !== ''):
					...
					foreach($rlist as $row): 
						...
						<tr bgcolor="<?=$bgcolor;?>" <?=$on_mouse;?>>
							...
							<?=anchor('mepromo-spqd-view/?spqd_trxno=' . $spqd_trx_no, '<i class="bi bi bi-pencil" style="background-color:#167F92; color:#fff; padding: 3px 5px 3px;; border-radius: 5px;"></i>',' class="btn btn-dgreen p-1 pb-0 mebtnpt1 btn-sm"');?>
							</td>
							...
							<td>
								<button class="btn btn-success btn-sm" onclick="javascript:__mbtn_promo_bdownload('<?=$row['spqd_trx_no'];?>');"<?=$dis;?> > <i class="bi bi-print"></i> Download</button>
							</td>
						</tr>
						<?php 
						$nn++;
