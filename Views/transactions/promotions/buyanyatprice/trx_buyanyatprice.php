...
$buyanyatprice_trxno = $request->getVar('buyanyxatpricey_trxno');
$mtkn_trxno = $request->getVar('mtkn_trxno');
$recid = '';
$nporecs = 0;
$txt_buyanyatpricetrxno = '';
$promo_name="";
$start_date = ''; 
...
if(!empty($buyanyatprice_trxno)) {
  $str = "
  select aa.`buyanyxatpricey_trxno`,
  aa.`branch_code`,
  bb.`BRNCH_NAME`,
  aa.`start_date`,
  aa.`start_time`,
  ...
  aa.`promo_name`,
  aa.is_approved
  from `trx_pos_promo_buyanyxatpricey_hd` aa 
  join `mst_companyBranch` bb
  on aa.`branch_code` = bb.`BRNCH_OCODE2`
  join `trx_pos_promo_buyanyxatpricey_dt` cc
  on aa.`buyanyxatpricey_trxno` = cc.`buyanyxatpricey_trxno`
  where aa.`buyanyxatpricey_trxno` = '$buyanyatprice_trxno' 
  ";
  ...
  $txt_buyanyatpricetrxno = $rw['buyanyxatpricey_trxno'];
...
<div class="card">
  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Promotion - BUY ANY X AT PRICE Y</li>
      </ol>
    </nav>
  </div> <!-- End Page Title -->
          ...
          <div class="row mb-3">
            <div class="col-lg-12">
              ...
              <div class="row mb-3">
                <label class="col-sm-3 form-label" for="txt_buyanyatprice">Buy Any X at Price Y :</label>
                <div class="col-sm-9">
                  <input type="text" id="txt_buyanyatpricetrxno" name="txt_buyanyatpricetrxno" placeholder="BUY ANY X AT PRICE Y Code" style="background-color: #EAEAEA;" class="form-control form-control-sm" value="<?=$txt_buyanyatpricetrxno;?>" readonly/>
                  <input type="hidden" id="__hmpromotrxnoid" name="__hmpromotrxnoid" class="form-control form-control-sm" value="<?=$buyanyatprice_trxno;?>"/>
                </div>
              </div> 
              ...
              <div class="row mb-3">
                <label class="col-sm-3 form-label" for="txt_promodesc">Buy Quanty And Price</label>
                <div class="col-sm-3">
                  <input type="text" id="txt_quantity" name="txt_quantity" placeholder="Quanty" class="form-control form-control-sm" value="<?=$txt_quantity;?>" />
                </div>
                <div class="col-sm-3">
                  <input type="text" id="txt_price" name="txt_price" placeholder="Price" class="form-control form-control-sm" value="<?=$txt_price;?>" />
                </div>
              </div> 
                ...
                <thead class="text-center">
                  ...
                  <tbody id="gwpo-recs">
                    ...
                    foreach($rrec as $rdt){
                      ...
                      <?php if(!empty($buyanyatprice_trxno)): 
                          
                          $str = "
                          select
                          aa.`buyanyxatpricey_trxno`,
                          dd.`ART_CODE`,
                          dd.`ART_DESC`,
                          dd.`ART_BARCODE1`
                          ...
                          join `mst_article` dd
                          on 
                          cc.`product_barcode` = dd.`ART_BARCODE1`
                          where aa.`buyanyxatpricey_trxno` = '$buyanyatprice_trxno' 
                          ";
                          ...
                          foreach ($rw as $data) {
                            ...
                            <td><?=$nporecs;?></td>
                              ...
                              <td nowrap="nowrap"><input type="text" size="50" class="form-control form-control-sm <?=$nporecs;?>" value="<?=$ART_BARCODE1;?>" style="background-color: #EAEAEA;" readonly></td>
	...
	jQuery('#branch_name')
        ...
        $('#mbtn_mn_NTRX').click(function() { 
          ...
          if (userselection == true){
            window.location = '<?=site_url();?>me-buyanyatprice';
          }
          else{
            $.hideLoading();
            return false;
    ...
    ?>
      $("#mbtn_mn_Save").click(function(e){
        ...
        try { 
          ...
          var txt_buyanyatprice = jQuery('#txt_buyanyatprice').val();
          ...
          var txt_price = jQuery('#txt_price').val()
          ...
          for(aa = 1; aa < rowCount1; aa++) { 
            ...
            mdata = mitemc + 'x|x' + mdesc + 'x|x' + mbcode + 'x|x' + mitemc_tkn;
            adata1.push(mdata);
            ...
            var mparam = {
              mtkn_mntr:mtkn_mntr,
              txt_buyanyatprice:txt_buyanyatprice,
            ...
            $.ajax({ 
              type: "POST",
              url: '<?=site_url();?>me-buyanyatprice-save',
    ...
    ?>
      ...
      function mypack_view_recs(mtkn_whse){ 
        ...
        ajaxRequest = jQuery.ajax({
          url: "<?=site_url();?>me-buyanyatprice-view",
          type: "post",
          data: {
            mtkn_whse: mtkn_whse
          }
  ...
  function mypack_view_appr(mtkn_whse){ 
    ...
    ajaxRequest = jQuery.ajax({
      url: "<?=site_url();?>me-buyanyatprice-view-appr",
      type: "post",
      data: {
        mtkn_whse: mtkn_whse
      }
