...
$mytrxpurch = model('App\Models\MyPromoThresholdModel');
...
<script type="text/javascript"> 
	...
	function __myredirected_rsearch_appr(mobj) { 
		try { 
			...
			type: "POST",
			url: '<?=site_url();?>me-threshold-appr',
	...
	function save_for_approve_promo(mtkn_fgpacktr){
		try { 
            __mysys_apps.mepreloader('mepreloaderme',true);
                  ...
                  jQuery.ajax({ // default declaration of ajax parameters
                    type: "POST",
                    url: '<?=site_url();?>me-threshold-appr-save',
                    context: document.body,
                    data: eval(mparam),
                    global: false,
                    cache: false,
