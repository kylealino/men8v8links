...
if(!empty($mtkn_fgpacktrr)) {
  ...
  $txt_amount = $rw['amount'];
  $txt_discount = $rw['discount'];
        ...
        <li class="breadcrumb-item active">Promotion - THRESHOLD</li>
          ...
          <div class="row mb-3">
            <div class="col-lg-12">
              ...
              <div class="row mb-3">
                <label class="col-sm-3 form-label" for="txt_promodesc">Amount and Discount</label>
                <div class="col-sm-3">
                  <input type="text" id="txt_amount" name="txt_amount" placeholder="Amount" onkeypress="return isNumeric(event)"class="form-control form-control-sm" value="<?=$txt_amount?>" />
                </div>
                <div class="col-sm-3">
                  <input type="text" id="txt_discount" name="txt_discount" placeholder="Discount" onkeypress="return isNumeric(event)" class="form-control form-control-sm" value="<?=$txt_discount;?>" />
                </div>
              </div> 
  ...
  <script type="text/javascript">
	...
	$(document).ready(function() {
		$('#txt_discount').change(function(){
			...
			var amount = jQuery('#txt_amount').val();
			var promo_name = 'Worth '+ amount + ' Discount ' + discount +'%';
    ...
    function __my_item_lookup(){
      ...
      $("#mbtn_mn_Save").click(function(e){
        ...
        try { 
          ...
          var txt_amount = jQuery('#txt_amount').val()
          ...
          for(aa = 1; aa < rowCount1; aa++) { 
            ...
            var ART_BARCODE1 = jQuery(clonedRow).find('input[type=text]').eq(2).val();
            var mitemc_tkn = jQuery(clonedRow).find('input[type=hidden]').eq(5).val(); 
            
            
            
            mdata = ART_CODE + 'x|x' + ART_DESC + 'x|x' + ART_BARCODE1 + 'x|x' + mitemc_tkn;
            adata1.push(mdata);
