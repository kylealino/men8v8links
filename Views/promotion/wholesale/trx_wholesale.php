                        ...
                        <?php if(!empty($mtkn_fgpacktrr)): 
                          ...
                          foreach ($rw as $data) {
                            ...
                            <tr>
                              ...
                              <td nowrap="nowrap"><input type="text" class="form-control form-control-sm" value="<?=$quantity;?>"></td> <!--4 Price -->
    ...
    jQuery('.company_name')
        ...
        function my_add_line_item_promo() {  
          try {
            ...
            jQuery(clonedRow).find('input[type=text]').eq(2).attr('id','ART_QUANTITY' + mid);
          ...
          .autocomplete({
            ...
            focus: function() {
                ...
                select: function( event, ui ) {
                  ...
                  var xobjitemART_QUANTITY = jQuery(clonedRow).find('input[type=text]').eq(2).attr('id');/*discount*/
                  ...
                  $('#' + xobjitemART_QUANTITY).val(ui.item.ART_QUANTITY);
      ...
      $("#mbtn_mn_Save").click(function(e){
        ...
        try { 
          ...
          for(aa = 1; aa < rowCount1; aa++) { 
            ...
            var ART_QUANTITY = jQuery(clonedRow).find('input[type=text]').eq(2).val();
            ...
            mdata = ART_CODE + 'x|x' + ART_DESC + 'x|x' + ART_QUANTITY + 'x|x' + discount_value + 'x|x' + ART_BARCODE1;
            adata1.push(mdata);
