...
use App\Models\MyPromoBuy1take1Model;
...
class Promo_buy1take1 extends BaseController
{
    //start construct
    public function __construct()
    {
        ...
        $this->mytrxpromo = new MyPromoBuy1take1Model();
    ...
    public function index()
    {
        ...
        //$result=$this->myusermod->get_Active_menus($this->db_erp,$cuser,"myuatrx_id='238'","myua_trx");
        //if($result==0):
        //    echo view('errors/html/error_404',$this->data);
        //    die();
        //endif;
        echo view('templates/meheader01');
        echo view('transactions/promotions/buy1take1/trx_buy1take1');
        echo view('templates/mefooter01');
    } //end index route
    
    public function buy1take1_save() { 
        $this->mytrxpromo->buy1take1_entry_save();
    } 
